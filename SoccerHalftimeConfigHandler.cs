...
{
    public class SoccerHalftimeConfigHandler
    {
        private readonly LineshouseContext _lineshouseContext;
        private readonly DgsContext _dgsContext;

        public SoccerHalftimeConfigHandler(LineshouseContext context, DgsContext dgsContext)
        {
        ...
        public void Handle()
        {
            ...
            foreach (var config in leaguesConfig)
            {
                ...
                var oldPropConfig = data.FirstOrDefault(x => x.Key == "0,0,0,21");
