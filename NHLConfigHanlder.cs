...
{
    public class NHLConfigHanlder
    {
        private readonly LineshouseContext _lineshouseContext;
        private readonly DgsContext _dgsContext;

        public NHLConfigHanlder(LineshouseContext context, DgsContext dgsContext)
        {
        ...
        public void Handle()
        {
            ...
            var leaguesConfig = this._dgsContext.Config.Include(x => x.League).Where(x => x.League.SportId == 19 && x.League.Description.Equals("NHL")).ToList();
